...
# 10 "../Core/Src/SDPro.c" 2
# 1 "../Core/Inc\\gpio.h" 1
# 107 "../Core/Inc\\gpio.h"
void MX_GPIO_Init(void);
# 11 "../Core/Src/SDPro.c" 2
...
# 15 "../Core/Src/SDPro.c" 2

extern SD_HandleTypeDef hsd;
# 80 "../Core/Src/SDPro.c"
void SaveDtatExScreen()
{
  ...
  USART_Data.USART1_Data.US1_c_ValN4,
  USART_Data.USART1_Data.US1_c_ValN5,
  comVariableBlock.ID_Sensor,
  0x0d, 0x0a);

     sprintf((char *)StrTemp, "Date\tVol1\tVol2\tVol3\tVol4\tDAC\tCur\tVal\tWave\tDAC\tCur\tVal\tWave\tCCur\tLkge\tResC\tResV\tLkge\tResC\tResV\tID%c%c",0x0d, 0x0a);

...
# 14 "../Core/Src/processing.c" 2
# 1 "../Core/Inc\\gpio.h" 1
# 107 "../Core/Inc\\gpio.h"
void MX_GPIO_Init(void);
# 15 "../Core/Src/processing.c" 2
...
# 16 "../Core/Src/processing.c" 2



const char WindowsTxtStr[][40] =
{
    "电压6V ",
    "电压5V ",
    "电压AVCC ",
...
void VariableInitialization()
{
 ...
 comVariableBlock.ProgressCoefficient = 100/((float)sizeof(WindowsTxtStr)/40 -1);
}


void RemoveLetter(char *strLetter, char *strNoLetter)
{
...
void DataFilling( char *str)
{
    char NoLetterStr[50] = {0};
 char StringLenBuf=0;
 static unsigned char StringBuf[50];
   ...
   comVariableBlock.SaveDataFlag=1;
            if(str[2] == 'o' && str[3] == 'u' && str[4] == 't')
            {
                ...
                USART_Data.USART1_Data.US1_a_Voltage = strtod((char *)NoLetterStr, 0);

            }
            else if(str[2] == 'm' && str[3] == 'a' && str[4] == 'x')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_a_Max_mA = strtod((char *)NoLetterStr, 0);
            }
            else if(str[2] == 'm' && str[3] == 'i' && str[4] == 'n')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_a_Min_mA = strtod((char *)NoLetterStr, 0);
            }
        }
        break;
        case 'p':
    ...
    if(comVariableBlock.MeasureResults != ResultsTesting)
    {
     ...
     HAL_UART_Transmit_IT(&huart1, StringBuf, StringLenBuf);
    }
   ...
   comVariableBlock.SaveDataFlag=1;
            ...
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_b_Max_mA0 = strtod((char *)NoLetterStr, 0);
            }else

            if(str[2] == 'b')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_b_Min_mA0 = strtod((char *)NoLetterStr, 0);
            }else

            if(str[2] == 'c')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_b_Max_mA1 = strtod((char *)NoLetterStr, 0);
            }else

            if(str[2] == 'd')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_b_Min_mA1 = strtod((char *)NoLetterStr, 0);
            }else

            if(str[2] == 'e')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_b_Max_mA2 = strtod((char *)NoLetterStr, 0);
            }else

            if(str[2] == 'f')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_b_Min_mA2 = strtod((char *)NoLetterStr, 0);
            }else

            if(str[2] == 'g')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_b_Max_mA3 = strtod((char *)NoLetterStr, 0);
            }else

            if(str[2] == 'h')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_b_Min_mA3 = strtod((char *)NoLetterStr, 0);
            }else

            if(str[2] == 'i')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_b_Max_mA4 = strtod((char *)NoLetterStr, 0);
            }else

            if(str[2] == 'z')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_b_Min_mA4 = strtod((char *)NoLetterStr, 0);
            }else

            if(str[2] == 'k')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_b_Max_mA5 = strtod((char *)NoLetterStr, 0);
            }else

            if(str[2] == 'l')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_b_Min_mA5 = strtod((char *)NoLetterStr, 0);
            }else

            if(str[2] == 'm')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_b_Max_mA6 = strtod((char *)NoLetterStr, 0);
            }else

            if(str[2] == 'n')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_b_Min_mA6 = strtod((char *)NoLetterStr, 0);
            }else

            if(str[2] == 'o')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_b_Max_mA7 = strtod((char *)NoLetterStr, 0);
            }else

            if(str[2] == 'p')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_b_Min_mA7 = strtod((char *)NoLetterStr, 0);
            }
   ...
   comVariableBlock.SaveDataFlag=1;
            ...
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_c_Max_mA1 = strtod((char *)NoLetterStr, 0);
            }else

            if(str[2] == 'b')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_c_Min_mA1 = strtod((char *)NoLetterStr, 0);
            }else

            if(str[2] == 'c')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_c_Max_mA2 = strtod((char *)NoLetterStr, 0);
            }else

            if(str[2] == 'd')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_c_Min_mA2 = strtod((char *)NoLetterStr, 0);
            }else

            if(str[2] == 'e')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_c_Max_mA3 = strtod((char *)NoLetterStr, 0);
            }else

            if(str[2] == 'f')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_c_Min_mA3 = strtod((char *)NoLetterStr, 0);
            }else

            if(str[2] == 'g')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_c_Max_mA4 = strtod((char *)NoLetterStr, 0);
            }else

            if(str[2] == 'h')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_c_Min_mA4 = strtod((char *)NoLetterStr, 0);
            }else

            if(str[2] == 'i')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_c_Max_mA5 = strtod((char *)NoLetterStr, 0);
            }else

            if(str[2] == 'z')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_c_Min_mA5 = strtod((char *)NoLetterStr, 0);
            }else

            if(str[2] == 'k')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_c_Max_mA6 = strtod((char *)NoLetterStr, 0);
            }else

            if(str[2] == 'l')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_c_Min_mA6 = strtod((char *)NoLetterStr, 0);
            }else

            if(str[2] == 'm')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_c_Max_mA7 = strtod((char *)NoLetterStr, 0);
            }else

            if(str[2] == 'n')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_c_Min_mA7 = strtod((char *)NoLetterStr, 0);
            }else

            if(str[2] == 'o')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_c_Max_mA8 = strtod((char *)NoLetterStr, 0);
            }else

            if(str[2] == 'p')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_c_Min_mA8 = strtod((char *)NoLetterStr, 0);
            }
  ...
  case 'L':
  {
   ...
   comVariableBlock.SaveDataFlag=1;
            ...
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_d_Max_Val = strtod((char *)NoLetterStr, 0);
            }else if(str[2] == 'b')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_d_Max_Va2 = strtod((char *)NoLetterStr, 0);
            }else if(str[2] == 'c')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_d_Max_Va3 = strtod((char *)NoLetterStr, 0);
            }else if(str[2] == 'd')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_d_Max_Va4 = strtod((char *)NoLetterStr, 0);
            }else if(str[2] == 'e')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_d_Max_Va5 = strtod((char *)NoLetterStr, 0);
            }else if(str[2] == 'f')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_d_Min_Val = strtod((char *)NoLetterStr, 0);
            }else if(str[2] == 'g')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_d_Min_Va2 = strtod((char *)NoLetterStr, 0);
            }else if(str[2] == 'h')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_d_Min_Va3 = strtod((char *)NoLetterStr, 0);
            }else if(str[2] == 'i')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_d_Min_Va4 = strtod((char *)NoLetterStr, 0);
            }else if(str[2] == 'z')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_d_Min_Va5 = strtod((char *)NoLetterStr, 0);
            }else if(str[2] == 'k')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_d_Max_Va6 = strtod((char *)NoLetterStr, 0);
            }else if(str[2] == 'l')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_d_Max_Va7 = strtod((char *)NoLetterStr, 0);
            }else if(str[2] == 'm')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_d_Max_Va8 = strtod((char *)NoLetterStr, 0);
            }else if(str[2] == 'n')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_d_Max_Va9 = strtod((char *)NoLetterStr, 0);
            }else if(str[2] == 'o')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_d_Max_Va10 = strtod((char *)NoLetterStr, 0);
            }else if(str[2] == 'p')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_d_Min_Va6 = strtod((char *)NoLetterStr, 0);
            }else if(str[2] == 'q')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_d_Min_Va7 = strtod((char *)NoLetterStr, 0);
            }else if(str[2] == 'r')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_d_Min_Va8 = strtod((char *)NoLetterStr, 0);
            }else if(str[2] == 's')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_d_Min_Va9 = strtod((char *)NoLetterStr, 0);
            }else if(str[2] == 't')
            {
                RemoveLetter(str, NoLetterStr);
                USART_Data.USART1_Data.US1_d_Min_Va10 = strtod((char *)NoLetterStr, 0);
            }
  }break;
    }
}
...
char *SetAutoDetecMultimeter(char NoAuto_Auto, unsigned short int OutTime)
{
 ...
 USART_Data.USART6_Data.US6_ReceiDataSucceCount=0;
    ...
    HAL_UART_Transmit_IT(&huart6, Sendstr, len);
    ...
    while(1)
    {
        ...
        {
            if(NoAuto_Auto == USART_Data.USART6_Data.US6_ReceiveDataNum[0])
            {
                SYS_tickTime.sys_WaitOutTime_ms = 0;
                break;
            }
...
char *SetPower(float SetValue, unsigned char Set_V0_C1_Get2, unsigned short int OutTime)
{
 ...
 static unsigned char Sendstr[30] = {0};
    ...
    if(Set_V0_C1_Get2 == 2)
    {
        ...
        strcat((char *)SendstrTrue, (char *)Sendstr);
        len += sprintf((char *)Sendstr, "%s%c", SendBuf[4], 0x0A);
        strcat((char *)SendstrTrue, (char *)Sendstr);
    }

    HAL_UART_Transmit_IT(&huart3, SendstrTrue, len);
    ...
    while(1)
    {
        ...
        if(USART_Data.USART3_Data.US3_SendDataSucce_Flag == 1)
        {
            ...
            if(Set_V0_C1_Get2 == 0 || Set_V0_C1_Get2 == 1)
            {
                return 0;
            }
...
char *SensorTransmit(unsigned char *Str, unsigned short int OutTime)
{
    ...
    HAL_UART_Transmit_IT(&huart4, StringTrue, len);
...
char *ScreenTransmit(USART_DataType *US_1, char (*str)[200], unsigned char lines, unsigned short int OutTime)
{
    static char ReturnNum = 0;
    static unsigned char StringTrue[1024];
    unsigned short int StringLen = 0, StringLenBuf = 0;
    unsigned char StringBuf[200 +4]={0};
 ...
 StringTrue[0]='\0';
    ...
    HAL_UART_Transmit_IT(&huart1, StringTrue, StringLen);
...
# 1132 "../Core/Src/processing.c"
}
# 1142 "../Core/Src/processing.c"
char *OutWindowsTxt2( unsigned char *ResultStr, unsigned char Result, char Restart, unsigned short int OutTime)
{

    static unsigned char OutWindowsTxtBuf1[40] = {0};
 ...
 if(comVariableBlock.Progress>100.0f)
 {
  comVariableBlock.Progress = 100;
    ...
    sprintf((char *)OutWindowsTxtBuf1, "%s%s%c%s%c%c", WindowsTxtStr[i], ResultStr, 0x20, Result_TxtTrs[Result], 0x0d, 0x0a);
    strcat((char *)OutWindowsTxtBuf2, (char *)OutWindowsTxtBuf1);
    Len = sprintf((char *)OutWindowsTxtSend, "main.mainOutTxt.txt=%c%s%c%c%c%c", '"', OutWindowsTxtBuf2, '"', 0xff, 0xff, 0xff);

 Len+=sprintf((char *)OutWindowsTxtBuf1, "main.mainj0.val=%d%c%c%c",comVariableBlock.Progress, 0xff, 0xff, 0xff);
 strcat((char *)OutWindowsTxtSend, (char *)OutWindowsTxtBuf1);

 Len+=sprintf((char *)OutWindowsTxtBuf1, "main.mainT0.txt=%c%d%%%c%c%c%c",'"',comVariableBlock.Progress,'"', 0xff, 0xff, 0xff);
 strcat((char *)OutWindowsTxtSend, (char *)OutWindowsTxtBuf1);

    HAL_UART_Transmit_IT(&huart1, OutWindowsTxtSend, Len);
    i++;
...
char *MeasurResultTransmit(unsigned char Result, unsigned short int OutTime)
{
    ...
    unsigned char colour[][10] = {"65520", "2024", "63488","63488"};
    unsigned char Len = 0;
 ...
 }else if(Result==3)
 {
  ...
  ID_TempResult[comVariableBlock.ID_RowCoordinate]=comVariableBlock.MeasureResults;
    ...
    Len = sprintf((char *)mainResultTxtSend, "%s%c%s%c%c%c%c",
                  mainResultTxtSendBuf, '"',showTXT[Result], '"', 0xff, 0xff, 0xff);


    Len += sprintf((char *)mainResultTxtBuf, "%s%s%c%c%c",
                   mainResultTxtSendBuf1, colour[Result], 0xff, 0xff, 0xff);

    strcat((char *)mainResultTxtSend, (char *)mainResultTxtBuf);

    HAL_UART_Transmit_IT(&huart1, mainResultTxtSend, Len);
...
char *NixieTubeTransmit(unsigned char NumberOfTimes, char On_Off, unsigned short int OutTime)
{
 ...
 for(int i=0;i<Resend;i++)
 {
  ...
  HAL_UART_Transmit_IT(&huart4, StringTrue, StringLen);

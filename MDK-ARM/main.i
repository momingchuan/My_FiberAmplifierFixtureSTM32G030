...
# 1 "../FATFS/App\\fatfs.h" 1
# 26 "../FATFS/App\\fatfs.h"
...
# 27 "../FATFS/App\\fatfs.h" 2
# 1 "../Middlewares/Third_Party/FatFs/src\\ff_gen_drv.h" 1
# 28 "../Middlewares/Third_Party/FatFs/src\\ff_gen_drv.h"
...
DWORD get_fattime (void);
# 29 "../Middlewares/Third_Party/FatFs/src\\ff_gen_drv.h" 2
# 38 "../Middlewares/Third_Party/FatFs/src\\ff_gen_drv.h"
typedef struct
{
...
# 28 "../FATFS/App\\fatfs.h" 2
# 1 "../FATFS/Target\\sd_diskio.h" 1
# 35 "../FATFS/Target\\sd_diskio.h"
extern const Diskio_drvTypeDef SD_Driver;
# 29 "../FATFS/App\\fatfs.h" 2
...
# 38 "../Core/Src/main.c" 2
# 1 "../Core/Inc\\SaveDATA.h" 1
# 34 "../Core/Inc\\SaveDATA.h"
typedef struct
 {
# 79 "../Core/Inc\\SaveDATA.h"
 float F32_1;
 float F32_2;
 float F32_3;
 float F32_4;
...
void WriteData(I2C_HandleTypeDef* i2cHandle,unsigned char *str_DATA,unsigned short int len);

extern DATA_blockType DATA_block;
# 39 "../Core/Src/main.c" 2
...
# 56 "../Core/Src/main.c"
unsigned char UART1_RX_BUF[1000];
unsigned char UART3_RX_BUF[50];
unsigned char UART4_RX_BUF[100];
unsigned char UART6_RX_BUF[100];
# 78 "../Core/Src/main.c"
...
int main(void)
{
 ...
 ((((((uint32_t)(1U << 28U | (0x1UL << (4U))))) >> 28U) == 1U)? ((&huart6)->Instance->CR1 |= ((((uint32_t)(1U << 28U | (0x1UL << (4U))))) & 0x0000FFFFU)): (((((uint32_t)(1U << 28U | (0x1UL << (4U))))) >> 28U) == 2U)? ((&huart6)->Instance->CR2 |= ((((uint32_t)(1U << 28U | (0x1UL << (4U))))) & 0x0000FFFFU)): ((&huart6)->Instance->CR3 |= ((((uint32_t)(1U << 28U | (0x1UL << (4U))))) & 0x0000FFFFU)));


 HAL_UART_Receive_DMA(&huart4,UART4_RX_BUF,100);
 ((((((uint32_t)(1U << 28U | (0x1UL << (4U))))) >> 28U) == 1U)? ((&huart4)->Instance->CR1 |= ((((uint32_t)(1U << 28U | (0x1UL << (4U))))) & 0x0000FFFFU)): (((((uint32_t)(1U << 28U | (0x1UL << (4U))))) >> 28U) == 2U)? ((&huart4)->Instance->CR2 |= ((((uint32_t)(1U << 28U | (0x1UL << (4U))))) & 0x0000FFFFU)): ((&huart4)->Instance->CR3 |= ((((uint32_t)(1U << 28U | (0x1UL << (4U))))) & 0x0000FFFFU)));
...
# 157 "../Core/Src/main.c"
 ...
 if(HAL_TIM_PWM_Start(&htim9,0x00000004U) != HAL_OK)
 {
  Error_Handler();
 }

 if(HAL_TIM_PWM_Start(&htim2,0x00000008U) != HAL_OK)
 {
  Error_Handler();
 }

 if(HAL_TIMEx_PWMN_Start(&htim8,0x00000000U) != HAL_OK)
 {
  Error_Handler();
 }
 ...
 switch(USART_Data.USART1_Data.PageNum)
 {
  case page_main:
  {
   if((((((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1000UL))->IDR&((uint16_t)0x8000))==(uint32_t)GPIO_PIN_RESET)?1:0) && SYS_tickTime.sys_sendTime_ms >= 1000)
   {

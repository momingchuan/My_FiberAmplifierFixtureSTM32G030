...
{
# 43 "../Core/Src/sdio.c"
  hsd.Instance = ((SDIO_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2C00UL));
  hsd.Init.ClockEdge = 0x00000000U;
  hsd.Init.ClockBypass = 0x00000000U;
  hsd.Init.ClockPowerSave = 0x00000000U;
  hsd.Init.BusWide = 0x00000000U;
  hsd.Init.HardwareFlowControl = 0x00000000U;
  hsd.Init.ClockDiv = 0;
...
void HAL_SD_MspInit(SD_HandleTypeDef* sdHandle)
{
  ...
  if(sdHandle->Instance==((SDIO_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2C00UL)))
  {
...
# 78 "../Core/Src/sdio.c"
    GPIO_InitStruct.Pin = ((uint16_t)0x0100)|((uint16_t)0x0200)|((uint16_t)0x0400)|((uint16_t)0x0800)
                          |((uint16_t)0x1000);
    ...
    hdma_sdio_rx.Instance = ((DMA_Stream_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x6400UL) + 0x058UL));
    hdma_sdio_rx.Init.Channel = 0x08000000U;
    hdma_sdio_rx.Init.Direction = 0x00000000U;
    hdma_sdio_rx.Init.PeriphInc = 0x00000000U;
    hdma_sdio_rx.Init.MemInc = ((uint32_t)(0x1UL << (10U)));
    hdma_sdio_rx.Init.PeriphDataAlignment = ((uint32_t)(0x2UL << (11U)));
    hdma_sdio_rx.Init.MemDataAlignment = ((uint32_t)(0x2UL << (13U)));
    hdma_sdio_rx.Init.Mode = ((uint32_t)(0x1UL << (5U)));
    hdma_sdio_rx.Init.Priority = ((uint32_t)(0x3UL << (16U)));
    hdma_sdio_rx.Init.FIFOMode = ((uint32_t)(0x1UL << (2U)));
    hdma_sdio_rx.Init.FIFOThreshold = ((uint32_t)(0x3UL << (0U)));
    hdma_sdio_rx.Init.MemBurst = ((uint32_t)(0x1UL << (23U)));
    hdma_sdio_rx.Init.PeriphBurst = ((uint32_t)(0x1UL << (21U)));
    if (HAL_DMA_Init(&hdma_sdio_rx) != HAL_OK)
    {
      Error_Handler();
    }

    do{ (sdHandle)->hdmarx = &(hdma_sdio_rx); (hdma_sdio_rx).Parent = (sdHandle); } while(0U);


    hdma_sdio_tx.Instance = ((DMA_Stream_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x6400UL) + 0x0A0UL));
    hdma_sdio_tx.Init.Channel = 0x08000000U;
    hdma_sdio_tx.Init.Direction = ((uint32_t)(0x1UL << (6U)));
    hdma_sdio_tx.Init.PeriphInc = 0x00000000U;
    hdma_sdio_tx.Init.MemInc = ((uint32_t)(0x1UL << (10U)));
    hdma_sdio_tx.Init.PeriphDataAlignment = ((uint32_t)(0x2UL << (11U)));
    hdma_sdio_tx.Init.MemDataAlignment = ((uint32_t)(0x2UL << (13U)));
    hdma_sdio_tx.Init.Mode = ((uint32_t)(0x1UL << (5U)));
    hdma_sdio_tx.Init.Priority = ((uint32_t)(0x3UL << (16U)));
    hdma_sdio_tx.Init.FIFOMode = ((uint32_t)(0x1UL << (2U)));
    hdma_sdio_tx.Init.FIFOThreshold = ((uint32_t)(0x3UL << (0U)));
    hdma_sdio_tx.Init.MemBurst = ((uint32_t)(0x1UL << (23U)));
    hdma_sdio_tx.Init.PeriphBurst = ((uint32_t)(0x1UL << (21U)));
    if (HAL_DMA_Init(&hdma_sdio_tx) != HAL_OK)
    {
      Error_Handler();
    }

    do{ (sdHandle)->hdmatx = &(hdma_sdio_tx); (hdma_sdio_tx).Parent = (sdHandle); } while(0U);
...
void HAL_SD_MspDeInit(SD_HandleTypeDef* sdHandle)
{
  ...
  if(sdHandle->Instance==((SDIO_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2C00UL)))
  {
    ...
    (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB2ENR &= ~((0x1UL << (11U))));
# 164 "../Core/Src/sdio.c"
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL)), ((uint16_t)0x0100)|((uint16_t)0x0200)|((uint16_t)0x0400)|((uint16_t)0x0800)
                          |((uint16_t)0x1000));

    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0C00UL)), ((uint16_t)0x0004));

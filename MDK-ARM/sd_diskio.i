# 1 "../FATFS/Target/sd_diskio.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 386 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../FATFS/Target/sd_diskio.c" 2
# 28 "../FATFS/Target/sd_diskio.c"
...
# 15 "../Middlewares/Third_Party/FatFs/src/diskio.h"
...
# 16 "../Middlewares/Third_Party/FatFs/src/diskio.h" 2
...
# 29 "../Middlewares/Third_Party/FatFs/src/ff.h"
...
DWORD get_fattime (void);
# 30 "../Middlewares/Third_Party/FatFs/src\\ff_gen_drv.h" 2
...
static DSTATUS SD_CheckStatus(BYTE lun)
{
  ...
  if(BSP_SD_GetCardState() == ((uint8_t)0x00))
  {
    Stat &= ~0x01;
  }
...
DRESULT SD_read(BYTE lun, BYTE *buff, DWORD sector, UINT count)
{
  ...
  if(BSP_SD_ReadBlocks((uint32_t*)buff,
                       (uint32_t) (sector),
                       count, 0xFFFFFFFFU) == ((uint8_t)0x00))
  {

    while(BSP_SD_GetCardState()!= ((uint8_t)0x00))
    {
    }
    res = RES_OK;
  }

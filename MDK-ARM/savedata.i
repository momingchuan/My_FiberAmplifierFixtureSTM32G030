# 1 "../Core/Src/SaveDATA.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 386 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Core/Src/SaveDATA.c" 2
...
# 11 "../Core/Src/SaveDATA.c" 2
# 1 "../Core/Inc\\gpio.h" 1
# 107 "../Core/Inc\\gpio.h"
void MX_GPIO_Init(void);
# 12 "../Core/Src/SaveDATA.c" 2
...
void SaveData_EX()
{
 ...
 WriteData(&hi2c1,comVariableBlock.SaveDATA_BUF,comVariableBlock.SaveDATA_BUF_Len);
}
...
void ReadData_EX()
{
 ...
 comVariableBlock.Coefficient_NPN_B= DATA_block.F32_40 ;
  ...
  {
  USART_Data.USART1_Data.US1_a_Voltage=50;
  }
...
void ReadData(I2C_HandleTypeDef* i2cHandle,unsigned char *str_DATA,unsigned short int len)
{
 HAL_I2C_Mem_Read_DMA(i2cHandle,0xA1,0, 0x00000001U,str_DATA,len);
}
...
void WriteData(I2C_HandleTypeDef* i2cHandle,unsigned char *str_DATA,unsigned short int len)
{
 ...
 while(pageNum)
 {
# 363 "../Core/Src/SaveDATA.c"
  HAL_I2C_Mem_Write_DMA(&hi2c1,0xA0,countNum,0x00000001U,str_DATA+countNum,16);
  pageNum--;
  countNum+=16;
  HAL_Delay(50);

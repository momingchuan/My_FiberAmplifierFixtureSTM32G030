...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../FATFS/Target/bsp_driver_sd.c" 2
# 35 "../FATFS/Target/bsp_driver_sd.c"
# 1 "../FATFS/Target/bsp_driver_sd.h" 1
# 29 "../FATFS/Target/bsp_driver_sd.h"
...
# 30 "../FATFS/Target/bsp_driver_sd.h" 2
...
# 36 "../FATFS/Target/bsp_driver_sd.c" 2



extern SD_HandleTypeDef hsd;
# 48 "../FATFS/Target/bsp_driver_sd.c"
__attribute__((weak)) uint8_t BSP_SD_Init(void)
{
  uint8_t sd_state = ((uint8_t)0x00);

  if (BSP_SD_IsDetected() != ((uint8_t)0x01))
  {
    return ((uint8_t)0x01);
  }
  ...
  if (sd_state == ((uint8_t)0x00))
  {

    if (HAL_SD_ConfigWideBusOperation(&hsd, (0x1UL << (11U))) != HAL_OK)
    {
      sd_state = ((uint8_t)0x01);
    }
  }
...
__attribute__((weak)) uint8_t BSP_SD_ITConfig(void)
{
...
__attribute__((weak)) void BSP_SD_DetectIT(void)
{

}
# 105 "../FATFS/Target/bsp_driver_sd.c"
__attribute__((weak)) uint8_t BSP_SD_ReadBlocks(uint32_t *pData, uint32_t ReadAddr, uint32_t NumOfBlocks, uint32_t Timeout)
{
  uint8_t sd_state = ((uint8_t)0x00);
...
__attribute__((weak)) uint8_t BSP_SD_WriteBlocks(uint32_t *pData, uint32_t WriteAddr, uint32_t NumOfBlocks, uint32_t Timeout)
{
  uint8_t sd_state = ((uint8_t)0x00);
...
__attribute__((weak)) uint8_t BSP_SD_ReadBlocks_DMA(uint32_t *pData, uint32_t ReadAddr, uint32_t NumOfBlocks)
{
  uint8_t sd_state = ((uint8_t)0x00);
...
__attribute__((weak)) uint8_t BSP_SD_WriteBlocks_DMA(uint32_t *pData, uint32_t WriteAddr, uint32_t NumOfBlocks)
{
  uint8_t sd_state = ((uint8_t)0x00);
...
__attribute__((weak)) uint8_t BSP_SD_Erase(uint32_t StartAddr, uint32_t EndAddr)
{
  uint8_t sd_state = ((uint8_t)0x00);
...
__attribute__((weak)) uint8_t BSP_SD_GetCardState(void)
{
  return ((HAL_SD_GetCardState(&hsd) == 0x00000004U ) ? ((uint8_t)0x00) : ((uint8_t)0x01));
}
...
__attribute__((weak)) void BSP_SD_GetCardInfo(HAL_SD_CardInfoTypeDef *CardInfo)
{
...
__attribute__((weak)) void BSP_SD_AbortCallback(void)
{
...
__attribute__((weak)) void BSP_SD_WriteCpltCallback(void)
{
...
__attribute__((weak)) void BSP_SD_ReadCpltCallback(void)
{

}
# 302 "../FATFS/Target/bsp_driver_sd.c"
__attribute__((weak)) uint8_t BSP_SD_IsDetected(void)
{

...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  if(uartHandle->Instance==((USART_TypeDef *) (0x40000000UL + 0x4C00UL)))
  {
    ...
    hdma_uart4_rx.Instance = ((DMA_Stream_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x6000UL) + 0x040UL));
    hdma_uart4_rx.Init.Channel = 0x08000000U;
    hdma_uart4_rx.Init.Direction = 0x00000000U;
    hdma_uart4_rx.Init.PeriphInc = 0x00000000U;
    hdma_uart4_rx.Init.MemInc = ((uint32_t)(0x1UL << (10U)));
    hdma_uart4_rx.Init.PeriphDataAlignment = 0x00000000U;
    hdma_uart4_rx.Init.MemDataAlignment = 0x00000000U;
    hdma_uart4_rx.Init.Mode = 0x00000000U;
    hdma_uart4_rx.Init.Priority = 0x00000000U;
    hdma_uart4_rx.Init.FIFOMode = 0x00000000U;
    if (HAL_DMA_Init(&hdma_uart4_rx) != HAL_OK)
    {
      Error_Handler();
    }

    do{ (uartHandle)->hdmarx = &(hdma_uart4_rx); (hdma_uart4_rx).Parent = (uartHandle); } while(0U);


    hdma_uart4_tx.Instance = ((DMA_Stream_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x6000UL) + 0x070UL));
    hdma_uart4_tx.Init.Channel = 0x08000000U;
    hdma_uart4_tx.Init.Direction = ((uint32_t)(0x1UL << (6U)));
    hdma_uart4_tx.Init.PeriphInc = 0x00000000U;
    hdma_uart4_tx.Init.MemInc = ((uint32_t)(0x1UL << (10U)));
    hdma_uart4_tx.Init.PeriphDataAlignment = 0x00000000U;
    hdma_uart4_tx.Init.MemDataAlignment = 0x00000000U;
    hdma_uart4_tx.Init.Mode = 0x00000000U;
    hdma_uart4_tx.Init.Priority = 0x00000000U;
    hdma_uart4_tx.Init.FIFOMode = 0x00000000U;
    if (HAL_DMA_Init(&hdma_uart4_tx) != HAL_OK)
    {
      Error_Handler();
    }

    do{ (uartHandle)->hdmatx = &(hdma_uart4_tx); (hdma_uart4_tx).Parent = (uartHandle); } while(0U);
  ...
  else if(uartHandle->Instance==((USART_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x1000UL)))
  {
    ...
    hdma_usart1_rx.Init.Priority = ((uint32_t)(0x1UL << (16U)));
    ...
    hdma_usart1_tx.Init.Priority = ((uint32_t)(0x1UL << (16U)));
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  else if(uartHandle->Instance==((USART_TypeDef *) (0x40000000UL + 0x4400UL)))
  {
    ...
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0C00UL)), ((uint16_t)0x0020)|((uint16_t)0x0040));
  ...
  else if(uartHandle->Instance==((USART_TypeDef *) (0x40000000UL + 0x4800UL)))
  {
    ...
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0400)|((uint16_t)0x0800));
